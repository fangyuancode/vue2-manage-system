        ...
        <el-row>
            <el-col :span="8" style="padding-right: 10px;">
                <el-card class="box-card">
                    <div class="user">
                        <img src="@/assets/images/渔火.jpeg" alt="">
                        <div class="userinfo">
                    ...
                    <div class="login-info">
                        <p>上次登录的时间：<span>2023-3-28</span></p>
                        <p>上次登录的地点：<span>浙江</span></p>
                    </div>
                </el-card>
                ...
                <el-card style="margin-top: 10px;height: 400px;">
                    ...
                    <el-table :data="tableData" style="width: 100%">
                        <el-table-column v-for="(val, key, index) in tableLabel " :key="index" :prop="key"
...
// 将Echarts引入到Vue文件中，然后就可以直接使用Echarts的功能
...
export default {
    ...
    mounted() {
        getData().then(({ data }) => {
            ...
            // 基于准好的dom,初始化echarts实例
            const echarts1 = echarts.init(this.$refs.echarts1);
            // 指定图表的配置和数据
            let echarts1Option = {}
            // 处理数据xaxis
            const { orderData } = data.data;
            // console.log("orderData", orderData.date);
